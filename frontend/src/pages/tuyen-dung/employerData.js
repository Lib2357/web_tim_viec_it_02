const STORAGE_KEY = 'chocode-employer-jobs'
...
const seedJobs = [
  {
    ...
    description:
      'Phối hợp với Product Manager và Engineering team để xây dựng trải nghiệm sản phẩm hiện đại cho hệ sinh thái ChoCode.',
    requirements:
    ...
    applicants: [
      ...
      { name: 'Minh Huy', initials: 'MH', tone: 'bg-sky-100 text-sky-600' },
...
export const statusOptions = ['Tất cả trạng thái', 'Đang hoạt động', 'Bản nháp']
...
export function statusClass(status) {
  return status === 'Đang hoạt động' ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600'
}
