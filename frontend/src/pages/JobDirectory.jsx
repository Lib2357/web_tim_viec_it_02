...
export default function JobDirectory() {
  ...
  const [statusOptions, setStatusOptions] = useState(['Chon trang thai'])
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const options = mock?.jobDirectory?.statusOptions || ['Chon trang thai']
  ...
  const filtered = useMemo(() => {
    if (status === 'Chon trang thai') return jobs
