  ...
  if (loading) {
    return (
      <div className="bg-[#f7f9fc] text-on-surface">
        ...
        <main className="ml-64 min-h-screen p-5 text-sm text-slate-500">Dang tai ho so da ung tuyen...</main>
      </div>
    )
  }
    ...
    return (
      <div className="bg-[#f7f9fc] text-on-surface">
        ...
        <main className="ml-64 min-h-screen p-5">
          <div className="rounded-xl border border-slate-200 bg-white p-5 text-sm text-slate-500 shadow-sm">Khong tim thay ho so ung tuyen phu hop voi `cv_id` nay.</div>
        </main>
      </div>
    )
  }
      ...
      <main className="ml-64 min-h-screen">
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="mb-1 flex items-center gap-2 text-sm text-slate-500">
                <Link to="/uploaded-cvs" className="font-medium text-blue-600 hover:underline">CV da tai len</Link>
                <span>/</span>
                <span>Cap nhat ho so</span>
              </div>
              <h1 className="text-[22px] font-extrabold leading-none tracking-tight text-slate-900">Cap nhat ho so da ung tuyen</h1>
            </div>
        ...
        <div className="grid grid-cols-1 gap-5 p-5 xl:grid-cols-[minmax(0,1.25fr)_360px]">
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Mo ta ngan ve ban than"
                />
              </div>
          ...
          <aside className="space-y-5">
            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              <h2 className="text-lg font-bold text-slate-900">Thong tin CV da dung</h2>
