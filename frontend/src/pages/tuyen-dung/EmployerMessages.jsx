  ...
  return (
    <div className="bg-[#f7f9fc] text-on-surface">
      ...
      <main className="ml-64 min-h-screen p-5">
        <h1 className="mb-4 text-[24px] font-bold">Employer Messages</h1>
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
          ...
          <section className="xl:col-span-8 rounded-xl border border-slate-200 bg-white p-4">
            <h2 className="mb-3 font-semibold">{active?.name || 'No conversation'}</h2>
            ...
            <div className="flex gap-2">
              ...
              <button className="rounded-lg bg-blue-600 px-4 text-white" onClick={send}>Gui</button>
            </div>
          </section>
        </div>
      </main>
